...
describe 'libvirt' do
  ...
  describe 'Test standard installation' do
    ...
    it { should contain_service('libvirt').with_ensure('running') }
    it { should contain_service('libvirt').with_enable('true') }
    it { should contain_file('libvirt.conf').with_ensure('present') }
  end
  ...
  describe 'Test standard installation with monitoring and firewalling' do
    ...
    it 'should monitor the process' do
      content = catalogue.resource('monitor::process', 'libvirt_process').send(:parameters)[:enable]
      content.should == true
    end
  ...
  describe 'Test customizations - template' do
    ...
    it 'should generate a valid template' do
      content = catalogue.resource('file', 'libvirt.conf').send(:parameters)[:content]
  ...
  describe 'Test customizations - source' do
    ...
    it 'should request a valid source ' do
      content = catalogue.resource('file', 'libvirt.conf').send(:parameters)[:source]
      content.should == "puppet://modules/libvirt/spec"
    end
    it 'should request a valid source dir' do
      content = catalogue.resource('file', 'libvirt.dir').send(:parameters)[:source]
      content.should == "puppet://modules/libvirt/dir/spec"
    end
    it 'should purge source dir if source_dir_purge is true' do
      content = catalogue.resource('file', 'libvirt.dir').send(:parameters)[:purge]
      content.should == true
    end
  end

  describe 'Test customizations - custom class' do
    let(:params) { {:my_class => "libvirt::spec" } }
  ...
  describe 'Test Puppi Integration' do
    ...
    it 'should generate a puppi::ze define' do
      content = catalogue.resource('puppi::ze', 'libvirt').send(:parameters)[:helper]
  ...
  describe 'Test Monitoring Tools Integration' do
    ...
    it 'should generate monitor defines' do
      content = catalogue.resource('monitor::process', 'libvirt_process').send(:parameters)[:tool]
  ...
  describe 'Test params lookup' do
    let(:facts) { { :libvirt_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
  ...
  describe 'Test params lookup' do
    let(:facts) { { :monitor => false , :libvirt_monitor => true , :ipaddress => '10.42.42.42' } }
    let(:params) { { :port => '42' } }
